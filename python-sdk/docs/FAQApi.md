...
with weknora_sdk.ApiClient(configuration) as api_client:
    ...
    api_instance = weknora_sdk.FAQApi(api_client)
...
```python
import weknora_sdk
from weknora_sdk.models.knowledge_bases_id_faq_entries_delete_request import KnowledgeBasesIdFaqEntriesDeleteRequest
from weknora_sdk.rest import ApiException
from pprint import pprint
...
with weknora_sdk.ApiClient(configuration) as api_client:
    ...
    request = weknora_sdk.KnowledgeBasesIdFaqEntriesDeleteRequest() # KnowledgeBasesIdFaqEntriesDeleteRequest | 要删除的FAQ ID列表
...
with weknora_sdk.ApiClient(configuration) as api_client:
    ...
    id = 'id_example' # str | 知识库ID
    entry_id = 'entry_id_example' # str | FAQ条目ID
    request = weknora_sdk.GithubComTencentWeKnoraInternalTypesFAQEntryPayload() # GithubComTencentWeKnoraInternalTypesFAQEntryPayload | FAQ条目
...
```python
import weknora_sdk
from weknora_sdk.models.github_com_tencent_we_knora_internal_types_faq_entry_fields_batch_update import GithubComTencentWeKnoraInternalTypesFAQEntryFieldsBatchUpdate
from weknora_sdk.rest import ApiException
from pprint import pprint
...
with weknora_sdk.ApiClient(configuration) as api_client:
    ...
    api_instance = weknora_sdk.FAQApi(api_client)
    id = 'id_example' # str | 知识库ID
    request = weknora_sdk.GithubComTencentWeKnoraInternalTypesFAQEntryFieldsBatchUpdate() # GithubComTencentWeKnoraInternalTypesFAQEntryFieldsBatchUpdate | 字段更新请求
...
```python
import weknora_sdk
from weknora_sdk.models.github_com_tencent_we_knora_internal_types_faq_batch_upsert_payload import GithubComTencentWeKnoraInternalTypesFAQBatchUpsertPayload
from weknora_sdk.rest import ApiException
from pprint import pprint
...
with weknora_sdk.ApiClient(configuration) as api_client:
    ...
    api_instance = weknora_sdk.FAQApi(api_client)
    id = 'id_example' # str | 知识库ID
    request = weknora_sdk.GithubComTencentWeKnoraInternalTypesFAQBatchUpsertPayload() # GithubComTencentWeKnoraInternalTypesFAQBatchUpsertPayload | 批量操作请求
...
```python
import weknora_sdk
from weknora_sdk.models.github_com_tencent_we_knora_internal_types_faq_search_request import GithubComTencentWeKnoraInternalTypesFAQSearchRequest
from weknora_sdk.rest import ApiException
from pprint import pprint
...
with weknora_sdk.ApiClient(configuration) as api_client:
    ...
    api_instance = weknora_sdk.FAQApi(api_client)
    id = 'id_example' # str | 知识库ID
    request = weknora_sdk.GithubComTencentWeKnoraInternalTypesFAQSearchRequest() # GithubComTencentWeKnoraInternalTypesFAQSearchRequest | 搜索请求
