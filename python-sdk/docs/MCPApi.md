...
with weknora_sdk.ApiClient(configuration) as api_client:
    ...
    api_instance = weknora_sdk.MCPApi(api_client)
...
```python
import weknora_sdk
from weknora_sdk.models.github_com_tencent_we_knora_internal_types_mcp_service import GithubComTencentWeKnoraInternalTypesMCPService
from weknora_sdk.rest import ApiException
from pprint import pprint
...
with weknora_sdk.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = weknora_sdk.MCPApi(api_client)
    request = weknora_sdk.GithubComTencentWeKnoraInternalTypesMCPService() # GithubComTencentWeKnoraInternalTypesMCPService | MCP服务配置
