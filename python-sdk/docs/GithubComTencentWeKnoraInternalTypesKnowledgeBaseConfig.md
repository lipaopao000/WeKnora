...
```python
from weknora_sdk.models.github_com_tencent_we_knora_internal_types_knowledge_base_config import GithubComTencentWeKnoraInternalTypesKnowledgeBaseConfig
