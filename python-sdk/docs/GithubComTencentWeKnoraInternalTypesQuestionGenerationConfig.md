...
```python
from weknora_sdk.models.github_com_tencent_we_knora_internal_types_question_generation_config import GithubComTencentWeKnoraInternalTypesQuestionGenerationConfig
